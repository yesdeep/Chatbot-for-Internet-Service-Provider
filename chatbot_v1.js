...
const { WebhookClient } = require("dialogflow-fulfillment");//http request sending
/**
 * A webhook is an HTTP request that is sent automatically whenever certain 
 * criteria is fulfilled. A webhook can be created in any server side programming 
 * language like Python, PHP or Node.
 */
const { Payload } =require("dialogflow-fulfillment");//rich text response giving
const app = express();
